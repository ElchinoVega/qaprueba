package com.ginni.bot.web;

import com.ginni.bot.web.exceptions.FrontEndException;
import com.ginni.bot.web.utility.ExtentReportUtil;
import com.ginni.bot.web.utility.GenerateWord;
import com.ginni.bot.web.utility.Sleeper;
...
public class BaseClass {
    ...
    public static void sendKeyValue(WebDriver driver, String key, String locator, String value) throws Throwable {
        try {
            ...
            generateWord.sendText("Se dio click en el elemento : " + locator);
...
//    }
    ...
    public static void errorDeCargaPantalla(AppiumDriver<MobileElement> driver, String msjPersonalizado) throws Exception{
    ...
    public static  void validaPantallaNoDeseadas(AppiumDriver<MobileElement> driver, String xpathElement, String msjPersonalizado) throws Exception{
        String cadena = driver.findElement(By.xpath(xpathElement)).getText();
